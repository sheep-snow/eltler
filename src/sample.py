...
USERNAME = settings.BOT_USERID # 'eltler.bsky.social'
PASSWORD = settings.BOT_APP_PASSWORD # 'wui7-mbll-zvpu-m34a'  # noqa: S105 never hardcode your password in a real application
